...
async function searchArtworks(search,size){
let newRequestUrl="https://api.artic.edu/api/v1/artworks/search?q="+search+"&size="+size
...
searchArtworks("cat",5)
searchArtworks("flower",2)
